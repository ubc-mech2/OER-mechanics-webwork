...
Given two forces acting on a particle at rest, $\overrightarrow{F_1}=([A]\hat{i}+0\hat{j}+0\hat{k})~ \text{N}$ and $\overrightarrow{F_2}=(-[B]\hat{i}+0\hat{j}+0\hat{k})~\text{N}$, is the particle in static equilibrium?
...
$$\overrightarrow{F_1}+\overrightarrow{F_2}=([A]\hat{i}+0\hat{j}+0\hat{k})~\text{N}+(-[B]\hat{i}+0\hat{j}+0\hat{k})~\text{N}=(-2\hat{i}+0\hat{j}+0\hat{k})~\text{N}$$
