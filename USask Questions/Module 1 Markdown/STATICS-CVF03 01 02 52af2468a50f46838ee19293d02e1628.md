...
![STATICS-CVF03%2001%2002%2052af2468a50f46838ee19293d02e1628/Untitled.png](STATICS-CVF03%2001%2002%2052af2468a50f46838ee19293d02e1628/Untitled.png)

# Answer:

a. $\vec{V}=2\hat{i}+3\hat{j}+2\hat{k}$

b. $\vec{V}=2\hat{i}+2\hat{j}+3\hat{k}$
...
In this question, the vector is going in the positive x-, y- and z-direction. So all of its components should be positive.
