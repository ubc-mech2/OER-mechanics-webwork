...
![STATICS-CVF03%2008%2001%208aa2d4db134449ad96f06cd8a837413e/Untitled.png](STATICS-CVF03%2008%2001%208aa2d4db134449ad96f06cd8a837413e/Untitled.png)

# Answer:

a. $\vec{V}=2\hat{i}-4\hat{j}-1\hat{k}$

b. $\vec{V}=1\hat{i}-4\hat{j}-2\hat{k}$

c. $\vec{V}=2\hat{i}-4\hat{j}+1\hat{k}$

d. $\vec{V}=2\hat{i}+4\hat{j}-1\hat{k}$
