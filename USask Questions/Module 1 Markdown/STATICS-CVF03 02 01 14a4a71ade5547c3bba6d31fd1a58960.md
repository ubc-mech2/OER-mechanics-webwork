...
![STATICS-CVF03%2002%2001%2014a4a71ade5547c3bba6d31fd1a58960/Untitled.png](STATICS-CVF03%2002%2001%2014a4a71ade5547c3bba6d31fd1a58960/Untitled.png)

# Answer:

a. $\vec{V}=-2\hat{i}+3\hat{j}+3\hat{k}$

b. $\vec{V}=-3\hat{i}+3\hat{j}+2\hat{k}$

c. $\vec{V}=2\hat{i}-3\hat{j}+3\hat{k}$

d. $\vec{V}=2\hat{i}+3\hat{j}-3\hat{k}$
...
In this question, the vector is going in the negative x-direction and in the positive y- and z-direction. So its x-component should be negative and its y- and z-components should be positive.
