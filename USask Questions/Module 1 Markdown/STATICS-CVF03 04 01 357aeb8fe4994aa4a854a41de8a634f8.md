...
![STATICS-CVF03%2004%2001%20357aeb8fe4994aa4a854a41de8a634f8/Untitled.png](STATICS-CVF03%2004%2001%20357aeb8fe4994aa4a854a41de8a634f8/Untitled.png)

# Answer:

a. $\vec{V}=1\hat{i}-3\hat{j}+2\hat{k}$

b. $\vec{V}=1\hat{i}-2\hat{j}+3\hat{k}$

c. $\vec{V}=-1\hat{i}-3\hat{j}+2\hat{k}$

d. $\vec{V}=1\hat{i}+3\hat{j}-2\hat{k}$
...
In this question, the vector is going in the positive x- and z-direction and in the negative y-direction. So its x- and z-components should be positive and its y-component should be negative.
