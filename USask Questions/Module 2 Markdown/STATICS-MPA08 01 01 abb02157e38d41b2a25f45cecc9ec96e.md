...
Given $\overrightarrow{F}=(2\hat{i}+3\hat{j}+1\hat{k})~\text{kN}$, and $\overrightarrow{r}=(0\hat{i}+0\hat{j}+2\hat{k})~\text{m}$, determine the moment produced by the force $\overrightarrow{F}$ about point O. Express the result as a Cartesian vector.

Enter your answer:     $($___$\hat{i}~~-$___$~\hat{j}~~+~$___$\hat{k})$  $\text{kN}\cdot\text{m}$

![STATICS-MPA08%2001%2001%20abb02157e38d41b2a25f45cecc9ec96e/Untitled.png](STATICS-MPA08%2001%2001%20abb02157e38d41b2a25f45cecc9ec96e/Untitled.png)
...
$$\overrightarrow{M_O}=\overrightarrow{r}\times\overrightarrow{F}=\begin{vmatrix}\hat{i}&\hat{j}&\hat{k}\\ 0&0&2\\ 2&3&1\\\end{vmatrix}$$

$$=\{0(1)-2(3)\}\hat{i}-\{0(1)-2(2)\}\hat{j}+\{0(3)-0(2)\}\hat{k}$$

$$=\{-6\hat{i}-(-4)\hat{j}+0\hat{k}\}~\text{kN}\cdot\text{m}$$