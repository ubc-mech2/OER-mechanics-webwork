...
filelocation=r'C:\Users\ptemm\Downloads\Dec 8 Export-3f72707b-dda5-4c06-a408-2a19b951f03a\GE 124 Question Database - Module 2 9cc673d992ce47c1b4b615581a5f7d90'
...
def translateline(line):
  ...
  line=re.sub('text{~(.*?)}',r'\1',line)
  line=re.sub('text{(.*?)}',r'\1',line)
  line=line.replace('[`[`\overrightarrow{F_2}`]=[____]{"$ans0"}`]','[`\overrightarrow{F_2}`]=[____]{"$ans0"}').replace('{j}`]) ','{j}`]) ')
